<template>
  <header class="page-header" :class="[collapse ? 'collapse' : '']" id="J-page-header">
    <div class="nav-container">
      <div class="nav-left">
        <div class="logo">
          <router-link :to="{ name: lang === 'en' ? 'Home-en' : 'Home' }">
            <img class="logo-img" src="~examples/assets/images/logo.png" preload="" />
            <span>UFIN-DESIGN</span>
          </router-link>
        </div>
      ...
      <div class="nav-right">
        <ul class="navbar">
          ...
          <li><router-link :to="{ path: '/component' }">组件</router-link></li>
        </ul>
      </div>
    </div>
  </header>
...
@import 'main/styles/themes/index';
