  ...
  <footer class="footer">
    <div class="container">
      ...
      <div class="footer-social">
        <p class="footer-social-title">UFIN-DESIGN {{ version && version.slice(0, 3) }} Fullerene</p>
...
export default {
  ...
  computed: {
    ...
    langConfig() {
      const config = compoLang.filter(config => config.lang === this.lang);

      if (config.length) {
        return config[0]['footer'];
      }
      return {};
    },
